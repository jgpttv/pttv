package com.cch.gsyvideoplayer.view;
...
public class FSLVCircularSmile extends View {
//    private final String defColor="#4385F5";
    ...
    public FSLVCircularSmile(Context context) {
        this(context, null);
    }

    public FSLVCircularSmile(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FSLVCircularSmile(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mColor= context.getResources().getColor(R.color.color_zhuti);
        initPaint();
    }
